...
export const LaunchListCell: FC<{
  ...
  const backgroundColor = launch.launch_success ? color.green700 : color.red700;
      ...
      <View style={styles.launchInnerContainer}>
        ...
        <View style={styles.textContainer}>
          <View style={styles.textRow}>
            ...
            <Text style={styles.smallText}>{launch.launch_site.site_name}</Text>
          </View>
          <Text style={styles.launchTitle}>{launch.mission_name}</Text>
          <View style={[styles.textRow, { paddingTop: 4 }]}>
            <Text style={styles.date}>
              {formatDate(launch.launch_date_utc)}
            </Text>
            <Text style={styles.time}>{timeAgo(launch.launch_date_utc)}</Text>
          </View>
        </View>
      </View>
    </TouchableOpacity>
